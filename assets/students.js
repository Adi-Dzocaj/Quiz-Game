...
// startButton.setAttribute('class', 'startButton btn btn-styling btn-lg btn-light w-50')
// startButton.innerHTML = 'Start The Game By Clicking The Button!'

// 	console.log(gameDisplayContainer.classList)
...
// 		gameDisplayContainer.classList.remove("d-none")
// 		console.log(gameDisplayContainer.classList)
// 	}
// })
    ...
    // <div id="startButtonContainer" class="d-flex justify-content-center align-items-center h-100"></div>